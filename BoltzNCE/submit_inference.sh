...
python infer_2aa.py --config saved_models/trained_vector_5_layer_ot_endpoint_tmax10_ema.yaml --n_sample_batches 2 --n_samples 500 --wandb_inference_name trained_vector_5_layer_ot_endpoint_tmax10_ema_test --NLL_samples 2 --w2_samples 500 --no-divergence