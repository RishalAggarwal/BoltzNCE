...
python infer_ad2.py --config saved_models/trained_vector_5_layer_ot_endpoint_tmax10_ema.yaml --n_sample_batches 20 --n_samples 500 --wandb_inference_name trained_vector_5_layer_ot_endpoint_tmax10_ema_new  