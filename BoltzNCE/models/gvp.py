#heavily inspired by the GVP implementation by Ian Dunn (https://github.com/Dunni3/FlowMol/blob/main/flowmol/models/gvp.py)
...
class GVP(nn.Module):
    ...
    def forward(self, data):
        ...
        if self.dim_vectors_out==1: #coordinate update
