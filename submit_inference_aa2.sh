...
python infer_aa2.py --config configs/infer_potential_aa2_window0250.yaml --no-divergence --wandb_inference_name inference_aa2_potential_training_GN_100k_window0250_kabsch --peptide GN --n_sample_batches 200
