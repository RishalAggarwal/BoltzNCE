...
python infer_aa2.py --config configs/infer_potential_aa2_medium_correctedbias.yaml --no-divergence --wandb_inference_name inference_aa2_potential_medium_correctedbias_NY_100k --peptide NY --n_sample_batches 200
